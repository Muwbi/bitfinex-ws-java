...
import cat.muwbi.bitfinex.ws.websocket.util.Callback;
...
public class WebSocketClientHandler extends SimpleChannelInboundHandler<Object> {
    ...
    @Setter
    private Callback<WebSocketClientHandler> connectedCallback;
    @Setter
    private Callback<Void> disconnectedCallback;
    ...
    public void channelInactive( ChannelHandlerContext channelHandlerContext ) {
        ...
        if ( this.disconnectedCallback != null ) {
            this.disconnectedCallback.done( null );
        }
    }
        ...
        if ( !handshaker.isHandshakeComplete() ) {
            try {
                ...
                if ( this.connectedCallback != null ) {
                    this.connectedCallback.done( this );
                }
